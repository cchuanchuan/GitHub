      ...
      <div class="table">
	    <table cellspacing="0" border="1">
	      <tr class="tablemenu" align="center">
	        <td colspan="99">
	        <form id="dateform" action="payinform.jsp">
	        ...
	        String sqlyear="select distinct year from pay";
	        ...
	        <option selected="selected" value=">0">全部</option>
	        <%
	        String sqlmonth = "select distinct month from pay";
	      ...
	      int totalpage=1;
	      int totalrecord=0;
	      String sqlpersonnum = "select count(*) from pay";
	      ...
	      String sqlperson="";
	      if(begin!=0){
		      sqlperson = "select top "+end+" * from pay where year"+year+" and month"+month
		    		  +" except " 
		    		  +"select top "+begin+" * from pay where year"+year+" and month"+month;
	      }
	      else{
	    	  sqlperson = "select top "+pagesize+" * from pay where year"+year+" and month"+month;
	      }
	      ...
	      <%if(Page!=1){
		      ...
		      <a href="payinform.jsp?Page=<%=(Page-1)%>">上一页&nbsp;</a>
		      <a href="payinform.jsp?Page=<%=(Page+1)%>">下一页</a>
	    	  <%
	      }
	      else{
	    	  %>
	    	  <span>&nbsp;第<%=Page %>页，共<%=totalpage %>页&nbsp;</span>
		      <a href="payinform.jsp?Page=<%=(Page+1)%>">下一页&nbsp;</a>
		      <a href="payinform.jsp?Page=<%=(totalpage)%>">最后一页&nbsp;</a>
		      <%
	      }
	      %>
	      </tr>

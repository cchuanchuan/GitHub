...
<div class="maincontent">
      <div class="tablename">
      <Strong>修改部门</Strong><small>/ManageDept</small>
      </div>
      <%
      ...
      %>
      <div class="table">
      <form action="deptmanagedo.jsp?deptno=<%=deptno %>" method="post" onsubmit="checkdept(this)">
	  ...
	  <div class="input"><input type="text" name="deptname" value="<%=deptname%>"></div>
	  </div>
	  
	  <div class="formcontent">
	  <div class="title">部门经理工号</div>
	  <div class="input"><input type="text" name="managerno" value="<%=managerno%>"></div>
	  </div>

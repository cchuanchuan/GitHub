...
<div class="maincontent">
      <div class="tablename">
      <Strong>职位管理</Strong><small>/Table</small>
      </div>
      ...
      for(int i=0;rsper.next();i++){
    	  ...
    	  %>
    	  <td>
    	  <button><a href="/PerSys/admin/websites/positionmanage.jsp?positionno=<%=rsper.getString("positionno")%>" target="mainframe">修改</a></button>
    	    <button><a href="/PerSys/admin/websites/positiondelete.jsp?positionno=<%=rsper.getString("positionno")%>" target="mainframe">删除</a></button>
    	  </td>
    	  </tr><%
      }
      %>

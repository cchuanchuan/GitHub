...
<div class="page-container">
  ...
  <div class="menu">
    <ul id="menu" >
      ...
      <li class="focus"><a href="change.jsp"><span>人事异动</span></a></li>
  ...
  <div class="right-content">
	...
	<div class="maincontent">
      <div class="tablename">
      <Strong>人事异动信息</Strong><small>/Table</small>
      </div>
      ...
      int totalpage=1;
      int totalrecord=0;
      String sqlpersonnum = "select count(*) from personchange";
      ...
      String sqlperson="";
      if(begin!=0){
	      sqlperson = "select top "+end+" * from personchange"
	    		  +" except " 
	    		  +"select top "+begin+" * from personchange";
      }
      else{
    	  sqlperson = "select top "+pagesize+" *from personchange";
      }
      ...
      <%if(Page!=1){
	      ...
	      <a href="change.jsp?Page=<%=(Page-1)%>">上一页&nbsp;</a>
	      <a href="change.jsp?Page=<%=(Page+1)%>">下一页</a>
    	  <%
      }
      else{
    	  %>
    	  <span>&nbsp;第<%=Page %>页，共<%=totalpage %>页&nbsp;</span>
	      <a href="change.jsp?Page=<%=(Page+1)%>">下一页&nbsp;</a>
	      <a href="change.jsp?Page=<%=(totalpage)%>">最后一页&nbsp;</a>
	      <%
      }
      %>
      </tr>

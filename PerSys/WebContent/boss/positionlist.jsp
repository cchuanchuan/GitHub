...
<html>
<head>
<title><%=request.getParameter("position") %></title>
...
<div class="page-container">
  ...
  <div class="menu">
    <ul id="menu" >
      ...
      <li><a href="dept.jsp"><span> 部门信息</span><span class="fr">></span></a>
        ...
        while(rs1.next()){
        	%>
            <li><a href="deptlist.jsp?dept=<%=rs1.getString("deptname")%>"><%=rs1.getString("deptname")%></a></li>
            <%
        }
        %>
		</ul>
        ...
        <ul>
             <%
		        ...
		        while(rs2.next()){
		        	...
		        	if(request.getParameter("position").equals(rs2.getString("positionname"))){
		        		%>
			            <li class="focus"><a href="positionlist.jsp?position=<%=rs2.getString("positionname")%>"><%=rs2.getString("positionname")%></a></li>
			            <%
		        	}else{
		        		%>
			            <li><a href="positionlist.jsp?position=<%=rs2.getString("positionname")%>"><%=rs2.getString("positionname")%></a></li>
			            <%
		        	}
  ...
  <div class="right-content">
	...
	<div class="maincontent">
      <div class="tablename">
      <Strong><%=request.getParameter("position") %></Strong><small><%=request.getParameter("positionno") %>/Table</small>
      </div>

...
<html>
<head>
<title><%=request.getParameter("dept")%></title>
...
<div class="page-container">
  ...
  <div class="menu">
    <ul id="menu" >
      ...
      <li><a href="dept.jsp"><span> 部门信息</span><span class="fr">></span></a>
        ...
        while(rs1.next()){
        	if(request.getParameter("dept").equals(rs1.getString("deptname"))){
        		%>
                <li class="focus"><a href="deptlist.jsp?dept=<%=rs1.getString("deptname")%>"><%=rs1.getString("deptname")%></a></li>
                <%
        	}
        	else{
        		%>
  ...
  <div class="right-content">
	...
	<div class="maincontent">
      <div class="tablename">
      <Strong><%=request.getParameter("dept")%></Strong><small><%=request.getParameter("deptno")%>/Table</small>
      </div>
